...
public class LGImgCompressor {
    ...
    private static final int DEFAULT_OUTWIDTH = 1600;
    private static final int DEFAULT_OUTHEIGHT = 1600;
    private static final int DEFAULT_MAXFILESIZE = 400;//KB
    ...
    private String getOutputFileName(String srcFilePath) {
        ...
        File file = new File(Environment.getExternalStorageDirectory().getPath(), ".十六番/.img_temp");
        if (!file.exists()) {
            file.mkdirs();
        }
